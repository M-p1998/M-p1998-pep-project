...
public class AccountDAO {
    ...
    public Account insertUser(Account acc) throws SQLException{
        ...
        // try {
        //     String checkIfExistsQuery = "SELECT * FROM  account WHERE username = ?;";
        //     preparedStatement = connection.prepareStatement(checkIfExistsQuery);
        ...
        //     String regNewAccount = "INSERT INTO account(username, password) VALUES (?,?);";
        //     preparedStatement= connection.prepareStatement(regNewAccount, Statement.RETURN_GENERATED_KEYS);
        //     preparedStatement.setString(1, acc.getUsername());
        ...
        //     ResultSet autoGeneratedKey = preparedStatement.getGeneratedKeys();
        //     if(autoGeneratedKey.next()){
        //         int accountId = autoGeneratedKey.getInt(1);
        ...
        // finally{
        //     try {
        //         if(autoGeneratedKey != null)autoGeneratedKey.close();
        ...
        //             registeredAccount = new Account(accountId, acc.getUsername(),acc.getPassword());
        //         }else{
        //             throw new SQLException("Creating account failed, please try again.");
        //         }
        // } catch (SQLException e) {
        //     System.out.println(e.getMessage());
        //     throw new SQLException("Creating account failed while inserting username and password.");
        // }
        String sql = "INSERT INTO Account (username, password) VALUES (?, ?)";
